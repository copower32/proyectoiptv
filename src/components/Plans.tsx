...
const Plans: React.FC = () => {
  ...
  const plans = {
    one: [
      { duration: "48 HORAS  ", oldPrice: "", price: "¡4€!", features: ["+65.000 Canales en vivo", "Ideal para un fin de semana", "Si solo deseas ver un evento deportivo", "Si antes de terminar la prueba deseas contratar cualquier PLAN tendras 4€ a favor."], isFree: true },
