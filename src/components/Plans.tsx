...
const Plans: React.FC = () => {
  ...
  const plans = {
    one: [
      { duration: "24 horas ", oldPrice: "", price: "¡Gratis!", features: ["+65.000 Canales en vivo", "+150.000 Películas Y Series", "Cambiar entre dispositivos", "Uso de VPN compatible", "Calidad 4k/HD/UHD", "Guía de televisión", "Mira en cualquier dispositivo", "Soporte VIP gratuito 24/7", "Tecnología anticongelante."], isFree: true },
